...
1. 打开 `设置 -> 第三方插件`
2. 刷新插件列表
3. 启用 `PDF Gemini Translate`
4. 进入插件设置，填入 Gemini API Key
...
- 默认结果为简体中文
- 也可以通过命令面板执行 `Translate current PDF selection with Gemini`
